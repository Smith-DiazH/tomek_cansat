...
PORT_LORA="/dev/ttyS4"
PORT_GPS="/dev/ttyS2"
DIR_PROYECTO="/home/radxa/Documents/yolo_npu"
...
echo "--------------------------------------------------------"
# Forzamos a que Python corra con sudo usando el binario del entorno virtual
sudo ./venv/bin/python sender_lora.py
